<?php
  ...
  if(isset($_FILES['image'])){
   ...
   if(empty($errors)==true){
     ...
     $sql = "INSERT INTO gas_cylinders (`title`,`content`,`featured_image`,`price`,`stock`) VALUES ('$name','$content','$file_name','$price','$stock')";
...
<body>
       ...
       <input type="number" name="price" required="required" placeholder="  Insert Price">
