...
if (isset($_POST['email'])) {
    ...
    try {
        ...
        // Content
        $url = "http://" . $_SERVER["HTTP_HOST"] . dirname($_SERVER["PHP_SELF"]) . "/update_staff_password.php?code=$code";
    ...
    <!--    </div> -->
        ...
        $mail->send();
        echo "<script >alert('Reset link has been sent to your email.'); window.location.herf='staff_signin.php';</script>";
    ...
    <div class="container">
        ...
        <div class="login-content">
            <form  method="POST" style="width: 400px !important;" name="email">
              ...
              <a href="staff_signin.php" id="signupnow">Back to login</a>
            </form>
        </div>
    </div>
