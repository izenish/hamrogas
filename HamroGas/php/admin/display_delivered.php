 ...
 <script type="text/javascript">
   function map(id2){
              ...
              Swal.fire({
                  ...
                  if (result.value) {     
                    window.location.href = "delivered_customer_map.php "+"?value="+id2;    
                  ...
                  if (result.value) {     
                    Swal.fire(
                          ...
                          'success'
                                ...
                                if (result.value) {
                                 // 
                                 window.location.href = "delete/delete_delivered.php"+"?value="+id1;
                                }
                                 // 
                                })    
              ...
              <li>
               ...
               <div class="dropdown-container" >
                    ...
                    <a href="pending.php" >
                      ...
                      <a href="Delivered_list.php"style="background: #5343c7; color: #fff;" >
                        <span class="icon"><i class="fas fa-cog"></i></span> 
    ...
    <li class="breadcrumb-item active" aria-current="page">Ordered list</li>
      ...
      <table class="table table-bordered table-striped table-hover">
        ...
        <tbody>
          <?php 
      $sn=1;
     $sql = mysqli_query($conn,"SELECT * FROM delivered");
   ...
   // echo "$value";
     ...
     ?>
          <tr>
            ...
            <td ><?php echo $main_result['C_id']?></td>
            ...
            <td><?php echo $main_result['Confirmed_date']; ?></td>
                      <!-- <td><?php// echo $main_result['item_price']; ?></td> -->
            
         <!--    <td><a href="delete.php?id=<?php// echo($main_result['id']);?>" class="text-danger"><i
                  class="fas fa-trash-alt"></i></a></td> -->
                <td align="center"><a onclick="map(<?php   echo($main_result['C_id']);?>);" style="cursor: pointer; color:#dd3e4e;"><i class="btn btn-primary" style="font-style: normal;">Location</i></a></td>  
                    <td align="center"><a onclick="confirm(<?php echo($main_result['C_id']);?>);" style="cursor: pointer; color:#dd3e4e;"><i class="fas fa-trash-alt"></i></a></td> 
